...
Route::group(['middleware' => ['admin']], function () {
    ...
    Route::post('/account/project/contacts/store', [ProjectController::class, 'store_contact'])->name('project.store_contact');
    ...
    Route::post('/project/file/change-flag', [FileController::class, 'changeFlag'])->name('project.file.changeFlag');
    Route::post('/project/file/make-for-claim', [FileController::class, 'change_for_tOrDOrV'])->name('project.file.change_for_tOrDOrV');
    ...
    Route::post('/export-excel-specific-documents', [FileDocumentController::class, 'download_excel_specific_documents'])->name('download.download_excel_specific_documents');
    ...
    Route::get('/project/para-wise-analysis/paragraphs/{id}', [ParaWiseController::class, 'paragraphs'])->name('project.para-wise-analysis.paragraphs');
    Route::get('/project/para-wise-analysis/paragraph/{id}/delete', [ParaWiseController::class, 'delete_paragraph'])->name('project.para-wise-analysis.delete_paragraph');
