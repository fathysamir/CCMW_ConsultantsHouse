...
class ProjectDashboardController extends ApiController
{
    public function index(Request $request)
    {
        ...
        if ($request->user) {
            ...
            $labels['allAssignmentUserDocuments']             = 'All active documents assigned to active open claim files';
            ...
            $labels['percent1']                               = 'Average percent of analysis complete for active open claim files';
            $labels['percent2']                               = 'Average percent of window analysis complete for active open claim files';
            $labels['ActiveOpenClaimFileVariation']           = 'All active open claim files include variation';
            $labels['FileVariation1']                         = 'All active open claim files which need ' . ($con1 ? $con1->name : '');
            $labels['FileVariation2']                         = 'All active open claim files which need ' . ($con2 ? $con2->name : '');
            $labels['FileVariation3']                         = 'All active open claim files which need ' . ($con3 ? $con3->name : '');
            $labels['FileVariation4']                         = 'All active open claim files which need ' . ($con4 ? $con4->name : '');
            $labels['FileVariation5']                         = 'All active open claim files which need ' . ($con5 ? $con5->name : '');
            $labels['FileVariation6']                         = 'All active open claim files which need ' . ($con6 ? $con6->name : '');
            $labels['allPendingAnalysisUserDocuments']        = 'All active documents need analysis';
            $labels['allPendingAssignmentUserDocuments']      = 'All active documents which not assigned to any file';
            $labels['ActiveOpenClaimFilesNeed1ClaimNotice']   = 'All active open claim files which need first claim notice';
            $labels['ActiveOpenClaimFilesNeedFurtherNotice']  = 'All active open claim files which need further notice';
            $labels['ActiveClaimFile']                        = 'All active claim files';
            $labels['ActiveOpenClaimFile']                    = 'All active open claim files';
            $labels['ActiveClosedClaimFile']                  = 'All active close claim files';
            $labels['ActiveOpenClaimFileTime']                = 'All active open claim files have time impact';
            $labels['ActiveOpenClaimFileProlongationCost']    = 'All active open claim files have prolongation cost impact';
            $labels['ActiveOpenClaimFileDisruption']          = 'All active open claim files have disruption impact';
            $labels['needChronology']                         = 'All active open claim files need chronology';
            $labels['needSynopsis']                           = 'All active open claim files need synopsis';
            $labels['needContractualA']                       = 'All active open claim files need contractual position';
            $labels['needCauseEffectA']                       = 'All active open claim files need cause-and-effect analysis';
            $selectedValue                                    = '';
