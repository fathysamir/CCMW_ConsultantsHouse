...
class DocumentController extends ApiController
{
    ...
    public function upload_single_doc(Request $request)
    {
        ...
        if ($request->use_ai == '1') {
            ...
            $message .= 'then \n';
            /////////////////////////////////////////////////////////////////////////////////////////
         $message .= ' Extract the first reference from this PDF, the reference must be separated by "/" or "-" in the PDF and don\'t Extract from 2 places in PDF . this is example:“1455/fde/5565/8542” \n';
