    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <div class="w-100 mb-4 d-flex">
            <a class="navbar-brand mx-auto mt-2 flex-fill text-center"
                href="{{ asset(url('/project?user=' . auth()->user()->code)) }}">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item">
                ...
                <a class="nav-link pl-3 link_kkkkk"
                    href="{{ url('/project?user=' . auth()->user()->code) }}"style="padding-left: 0.5rem !important;"><img
                        src="{{ asset('/dashboard/assets/selected_images/home.ico') }}" width="22"><span
                        class="ml-1 item-text" style="margin-left: 1rem !important;color:whitesmoke;">
                        Home</span></a>
            </li>
            <li class="nav-item dropdown">
                <a href="#Files" data-toggle="collapse" aria-expanded="false"
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="Project">
                    <li class="nav-item">
                        <a
                            class="nav-link pl-3 link_kkkkk"href="{{ route('account.edit_project_view', $project->slug) }}">
                            <span class="ml-1 item-text"style="color: #e4d125;">Project Card</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a
                            class="nav-link pl-3 link_kkkkk"href="{{ route('account.project.stakeholders_view', $project->slug) }}">
                    ...
                    @if (auth()->user()->roles->first()->name == 'Super Admin' ||
                            in_array('show_project_contacts', $Project_Permissions ?? []))
                        <li class="nav-item">
            ...
            @if (auth()->user()->roles->first()->name == 'Super Admin' || $found2 == true)
                <li class="nav-item dropdown">
                    <a href="#Documents" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle nav-link link_kkkkk">
                    ...
                    <ul class="collapse list-unstyled pl-4 w-100" id="Documents">
                        @if (auth()->user()->roles->first()->name == 'Super Admin' || in_array('upload_documents', $Project_Permissions ?? []))
                            <li class="nav-item">
                                <a class="nav-link pl-3 link_kkkkk"
                                    href="{{ route('project.upload_single_doc.create') }}"><span
                        ...
                        @if (auth()->user()->roles->first()->name == 'Super Admin' || in_array('import_documents', $Project_Permissions ?? []))
                            <li class="nav-item">
                                <a class="nav-link pl-3 link_kkkkk" style="font-size: 0.8rem;"
                                    href="{{ route('import_docs_view') }}"><span
                                        class="ml-1 item-text"style="color: #e4d125;">Import
                                        Documents
                                        from Excel</span></a>
                            </li>
                        @endif
                        @if (auth()->user()->roles->first()->name == 'Super Admin' || in_array('import_documents', $Project_Permissions ?? []))
                            <li class="nav-item">
                                <a class="nav-link pl-3 link_kkkkk" style="font-size: 0.8rem;"
                                    href="{{ route('import_notes_view') }}"><span
                                        class="ml-1 item-text"style="color: #e4d125;">Import
                                        Notes
                                        from Excel</span></a>
                            </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="collapse list-unstyled pl-4 w-100" id="forms">
                        ...
                        @if (auth()->user()->roles->first()->name == 'Super Admin' || in_array('show_document_type', $Project_Permissions ?? []))
                            <li class="nav-item">
                                <a class="nav-link pl-3 link_kkkkk"
                                    href="{{ route('project.document-types') }}"><span
