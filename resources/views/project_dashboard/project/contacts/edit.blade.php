...
@section('title', 'Project Home - Edit Contact')
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form method="post" action="{{ route('project.update_contact', $contact->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            <label for="simpleinputRole">Role</label>
                            <input type="text" name="role" required id="simpleinputRole" class="form-control"
                                placeholder="Role"value="{{ $contact->role }}">
                        </div>
                        <div class="form-group" style="font-size: 0.875rem;">
                             <label for="simpleinputPhone">Phone Number</label>
                            <div class="input-group">
                                @php
                                    $country_code = $contact->country_code; // Default to Egypt (+20) if not found
                                @endphp
                                <div class="input-group-prepend " style="width: 24%;margin-right:1%;">
                                    <select name="country_code" class="form-control form-control-lg" style="font-size: 0.875rem;">
                                ...
                                <input type="number"id="simpleinputPhone" name="phone" class="form-control form-control-lg"
                                    placeholder="Phone Number" value="{{ old('phone',$contact->phone) }}"
                                    style="border-top-left-radius: 0.3rem;border-bottom-left-radius: 0.3rem;font-size: 0.875rem;">
                            </div>
                           
                        </div>
                        <div class="form-group mb-3">
                            <label for="simpleinputEmail">Email</label>
                            <input type="email" name="email" required id="simpleinputEmail" class="form-control"
