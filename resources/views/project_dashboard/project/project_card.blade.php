                ...
                <div class="col-md-12">
                    <form method="post" action="{{ route('projects.update_project', $project->id) }}"
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                ...
                                @else
                                    <div style="display: flex;margin-right:6%;cursor: pointer;">
                                        <img class="d-none"
                                            src="{{ asset('dashboard/assets/selected_images/eye3.png') }}" width="50"
                                            title="PDF" style="margin-bottom: -10px;"id="viewPdf">
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                ...
                                @else
                                    <div style="display: flex;margin-right:6%;cursor: pointer;">
                                        <img class="d-none"
                                            src="{{ asset('dashboard/assets/selected_images/eye3.png') }}" width="50"
                                            title="PDF" style="margin-bottom: -10px;"id="viewPdf2">
                        ...
                        <button type="submit" class="btn mb-2 btn-outline-primary"id="btn-outline-primary"
                            onclick="document.getElementById('formAction').value='update'">Save &
                            Close</button>
