...
@section('title', 'Project Home - Update User')
@section('content')
    <style>
        .custom-fieldset {
                ...
                <div class="col-md-12">
                    <form method="post" action="{{ route('project.update_user', $user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group"
                            ...
                            <h5 style="margin-right: 10px;">Project Permissions</h5>
                            <hr style="flex: 1; margin: 0;">
                        </div>
                        <div class="form-group">
                            ...
                            <fieldset class="custom-fieldset">
                                ...
                                <div class="row" style="margin-left: 50px;">
                                    ...
                                    <div class="custom-control custom-checkbox" style="width:25%">
                                        ...
                                        <label class="custom-control-label" for="analysis{{ $project->id }}">Analysis
                                            Documents</label>
                                    </div>
                                    <div class="custom-control custom-checkbox" style="width:25%">
                                        ...
                                        <label class="custom-control-label" for="create_file{{ $project->id }}">Create
                                            Files</label>
                                    </div>
                                    <div class="custom-control custom-checkbox" style="width:25%">
                                    ...
                                    <div class="custom-control custom-checkbox" style="width:25%">
                                        ...
                                        <label class="custom-control-label" for="delete_file{{ $project->id }}">Delete
                                            Files</label>
                                    </div>
                                    <div class="custom-control custom-checkbox" style="width:25%">
                                        ...
                                        <label class="custom-control-label" for="cope_move_file{{ $project->id }}">Copy
                                            And Move
                                            Files</label>
                                    </div>
                                    ...
                                    <div class="custom-control custom-checkbox" style="width:25%">
                                        ...
                                        <label class="custom-control-label"
                                            for="show_project_contacts{{ $project->id }}">Show Project Contacts</label>
                                    </div>
                                    <div class="custom-control custom-checkbox" style="width:25%">
                                    ...
                                    <div class="custom-control custom-checkbox" style="width:25%">
                                        ...
                                        <label class="custom-control-label"
                                            for="edit_project_contact{{ $project->id }}">Edit Project Contact</label>
                                    </div>
                                    <div class="custom-control custom-checkbox" style="width:25%">
                                    ...
                                    <div class="custom-control custom-checkbox" style="width:25%">
                                        ...
                                        <label class="custom-control-label"
                                            for="show_window_narrative_settings{{ $project->id }}">Show
                                    ...
                                    <div class="custom-control custom-checkbox" style="width:25%">
                                        ...
                                        <label class="custom-control-label"
                                            for="edit_window_narrative_settings{{ $project->id }}">Edit Window Narrative
                                            Settings</label>
                                    </div>
