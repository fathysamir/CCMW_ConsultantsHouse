...
<style>
    ...
    <h2 id="toggleTitle" style="cursor:pointer;" class="page-title"><span id="chevronIcon" class="fe fe-24 fe-chevrons-right"></span>{{ $file->name }} - {{ $Type_Name[$type] }} Create File Attachment
        </h2>
    @if (session('error'))
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form id="formNarrative" method="post"
                        action="{{ route('project.stor_attachment.stor') }}"
                        enctype="multipart/form-data">
                        @csrf

                        <input hidden name="type" value="{{ $type }}">
                        <input hidden name="file_id" value="{{ $file->id }}">
                            ...
                            <div class="col-md-5">
                                <div class="row"style="margin-left: 50px;">
                                    ...
                                    <div class="custom-control custom-checkbox" style="margin-right: 20px;margin-top: 6.5%;">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" name="forClaim" id="forClaim"checked >
                        ...
                        <div class="text-right" style="margin-top: 10px;">
                            <button type="submit"
                                class="btn mb-2 btn-outline-success">Save</button>
