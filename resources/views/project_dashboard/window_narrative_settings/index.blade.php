...
@section('title', 'Project Home - Window Narrative Settings')
@section('content')
                            ...
                            @foreach ($settings as $setting)
                                <tr>
                                    <td><a class="l-link"style="color:rgb(80, 78, 78);" style="color:"
                                            href="{{ route('project.window-narrative-settings.edit', $setting->id) }}">
                                    ...
                                    <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item"
                                                href="{{ route('project.window-narrative-settings.edit', $setting->id) }}">Edit</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
