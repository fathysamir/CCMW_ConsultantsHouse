                ...
                <div class="col-md-12">
                    <form method="post" action="{{ route('accounts.project-folders.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text"style="background-color:#fff;" name="label1" id="against_id"
                                class="form-control date" placeholder="Against"value="{{ old('label1') }}">
                        </div>
                        <div class="row">
                            <!-- Name Input -->
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="label2" id="start_date" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="label3" id="end_date" class="form-control"
                                        placeholder="End Date"value="{{ old('label3') }}">
                                </div>
                            </div>
