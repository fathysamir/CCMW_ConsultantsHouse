      ...
      <div id="background-div" class="row align-items-center h-100" style="background-image: url('{{ asset('dashboard/assets/images/bg3.jpg') }}'); background-size: cover; background-repeat: no-repeat; background-position: center;">
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center"action="{{ route('sign-up') }}" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="email" id="inputEmail" class="form-control form-control-lg" name="email" placeholder="Email address" value="{{$email}}" required autofocus="">
            @if ($errors->has('email'))
                    <p class="text-error more-info-err" style="color: red;">
          ...
          <div class="form-group">
            ...
            <input type="password" id="inputConfirmPassword" name="password_confirmation" class="form-control form-control-lg" placeholder="Confirm Password" required>
