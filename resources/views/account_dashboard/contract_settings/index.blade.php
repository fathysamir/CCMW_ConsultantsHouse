...
@section('content')
    ...
    <div class="row align-items-center my-4" style="margin-top: 0px !important; justify-content: center;">
        ...
        @if (auth()->user()->roles->first()->name == 'Super Admin' ||
                in_array('create_contract_settings', $Account_Permissions ?? []))
            <div class="col-auto">
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @if (auth()->user()->roles->first()->name == 'Super Admin' ||
                                                    in_array('edit_contract_settings', $Account_Permissions ?? []))
                                                <a class="dropdown-item"
                                                    href="{{ route('account.contract-settings.edit', $setting->id) }}">Edit</a>
                                            @endif
                                            @if (auth()->user()->roles->first()->name == 'Super Admin' ||
                                                    in_array('delete_contract_settings', $Account_Permissions ?? []))
